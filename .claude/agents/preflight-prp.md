...
- Use Bash (ls, tree commands) to understand high-level project structure (modules/components)
...
If critical gaps are identified, use AskUserQuestion tool to gather clarifications:

- Structure questions with clear, short headers (max 12 chars)
- Provide 2-4 meaningful options for each question
...
- Limit to 1-4 questions per interaction to avoid overwhelming the user
