...
1. **Project Structure Analysis**
   - Use Bash (ls, tree commands) to examine the overall project structure and module organization
   ...
   - You can use Context7 MCP tools to gain more information about frameworks:
      - Use mcp__context7__resolve-library-id to find if there is a library for that tech
      - Use mcp__context7__query-docs to get the library documentation
   - Consider using AskUserQuestion for technical clarifications about architecture decisions
...
8. **Testing Infrastructure Analysis** (when used for test documentation generation)
   ...
   - Identify test directories structure (tests/, **tests**, spec/, test/)
...
- Use Task tool to delegate complex multi-layer analysis to other specialized agents
- Use AskUserQuestion when you need clarification on:
  - Ambiguous architectural decisions
  - Technical preferences between multiple valid patterns
  - Scope of research when boundaries are unclear
