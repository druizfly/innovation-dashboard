...
tools: Read, Glob, Write, TaskCreate, TaskUpdate, TaskList, Task
model: opus
---
...
**Initial Setup:**
- Create workflow tasks using TaskCreate to track your progress through the breakdown process
- Mark tasks as in_progress when starting each phase
- Mark tasks as completed when each phase finishes

1. **Load and Analyze PRP Document**
   - Use TaskCreate to create task: "Analyze PRP document"
...
2. **Perform Complexity Assessment**
   - Use TaskCreate to create task: "Assess complexity and dependencies"
   - Evaluate technical complexity (simple/moderate/complex)
   - Identify integration points and dependencies
   - Determine if phase-based organization is needed (10+ tasks)
   - Mark assessment task as completed with TaskUpdate

3. **Create Work Breakdown Structure**
   - Use TaskCreate to create task: "Create work breakdown structure"
   ...
   - Consider using Task tool to delegate complex analysis to codebase-research agent
   - Mark WBS task as completed with TaskUpdate

4. **Define Task Dependencies**
   - Use TaskCreate to create task: "Define task dependencies"
   - Map sequential dependencies between tasks
   - Identify parallel work opportunities
   - Highlight critical path items
   - Note integration and testing dependencies
   - Mark dependencies task as completed with TaskUpdate

5. **Establish Acceptance Criteria**
   - Use TaskCreate to create task: "Establish acceptance criteria"
   - Define measurable success criteria for each task
   - Include validation requirements from PRP
   - Specify testing requirements
   - Note documentation needs
   - Mark acceptance criteria task as completed with TaskUpdate

6. **Organize Implementation Phases** (if needed)
   - Use TaskCreate to create task: "Organize implementation phases"
   ...
   - Mark phases task as completed with TaskUpdate

7. **Generate Task Breakdown Document**
   - Use TaskCreate to create task: "Generate task breakdown document"
   ...
   - Mark document generation task as completed with TaskUpdate

8. **Provide Implementation Recommendations**
   - Use TaskCreate to create task: "Provide implementation recommendations"
   - Suggest optimal task sequencing
   - Recommend team structure and roles
   - Identify potential parallelization opportunities
   - Mark recommendations task as completed with TaskUpdate
...
- Use TaskCreate/TaskUpdate to track your own progress through the breakdown workflow
- Use Task tool to delegate complex codebase analysis to specialized agents
- Keep the user informed of progress through task status updates
