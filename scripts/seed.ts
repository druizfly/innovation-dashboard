...
const techRadarData: (typeof techRadar.$inferInsert)[] = [
  // Explore (5)
  { technologyName: "Bun Runtime", category: "explore", description: "JavaScript runtime alternative to Node.js with built-in bundler and test runner.", rationale: "Potential performance gains for serverless functions and build tooling.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "WebAssembly Components", category: "explore", description: "WASM component model for portable, language-agnostic modules.", rationale: "Could enable polyglot microservices with near-native performance.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "CockroachDB", category: "explore", description: "Distributed SQL database with strong consistency and horizontal scaling.", rationale: "Evaluate for geo-distributed workloads requiring ACID compliance.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "Deno 2", category: "explore", description: "Secure JavaScript/TypeScript runtime with native npm compatibility.", rationale: "Improved security model and npm compatibility make it worth evaluating.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "EdgeDB", category: "explore", description: "Graph-relational database with built-in migrations and type-safe queries.", rationale: "Novel query language could simplify complex data modeling.", createdBy: "admin", updatedBy: "admin" },

  // Adopt (6)
  { technologyName: "Next.js 15", category: "adopt", description: "React framework with server components, streaming, and edge runtime.", rationale: "Proven framework with strong ecosystem. Standard for all new web projects.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "PostgreSQL 16", category: "adopt", description: "Advanced open-source relational database with JSON support and extensions.", rationale: "Industry-standard RDBMS. Required for all new services.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "Kubernetes", category: "adopt", description: "Container orchestration platform for production workloads.", rationale: "De facto standard. All production services must deploy to K8s.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "TypeScript", category: "adopt", description: "Typed superset of JavaScript for large-scale application development.", rationale: "Mandatory for all JavaScript projects. Reduces runtime errors significantly.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "OpenTelemetry", category: "adopt", description: "Vendor-neutral observability framework for traces, metrics, and logs.", rationale: "Standardized observability. Replaces vendor-specific instrumentation.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "Drizzle ORM", category: "adopt", description: "Lightweight TypeScript ORM with SQL-like query builder.", rationale: "Type-safe, performant, and close to SQL. Recommended for all Node.js services.", createdBy: "admin", updatedBy: "admin" },

  // Consolidate (5)
  { technologyName: "Express.js", category: "consolidate", description: "Minimal Node.js web framework.", rationale: "Migrate to Hono or Next.js API routes for new projects. Maintain existing only.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "MongoDB", category: "consolidate", description: "Document database used in legacy services.", rationale: "Migrate to PostgreSQL where possible. No new MongoDB deployments.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "Jenkins", category: "consolidate", description: "Legacy CI/CD server.", rationale: "Migrate all pipelines to GitHub Actions by Q3 2026.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "Sequelize", category: "consolidate", description: "Promise-based Node.js ORM.", rationale: "Replace with Drizzle ORM in all services during next refactoring cycle.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "REST APIs (internal)", category: "consolidate", description: "Traditional REST for inter-service communication.", rationale: "Migrate to gRPC or GraphQL federation for internal APIs.", createdBy: "admin", updatedBy: "admin" },

  // Avoid (4)
  { technologyName: "jQuery", category: "avoid", description: "DOM manipulation library.", rationale: "No new usage. Modern React patterns replace all jQuery use cases.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "CoffeeScript", category: "avoid", description: "Legacy compile-to-JS language.", rationale: "TypeScript is the standard. CoffeeScript has no community support.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "Heroku", category: "avoid", description: "PaaS for deployment.", rationale: "Costs are prohibitive at scale. Use Kubernetes on cloud provider.", createdBy: "admin", updatedBy: "admin" },
  { technologyName: "Angular.js (v1)", category: "avoid", description: "Legacy frontend framework.", rationale: "End of life. Migrate remaining apps to React/Next.js immediately.", createdBy: "admin", updatedBy: "admin" },
];
