...
interface AdminTechRadarDetailPageProps {
...
export default async function AdminTechRadarDetailPage({
  params,
}: AdminTechRadarDetailPageProps) {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <Link href={`/admin/tech-radar/${item.id}/edit`}>
